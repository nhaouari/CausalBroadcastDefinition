...
var Unicast = require('./unicast-definition/lib/unicast.js');
...
CausalBroadcast.prototype.receiveUnicast = function(id, message){
    ...
    case 'MAntiEntropyResponse':
        ...
        if (this.bufferAntiEntropy.elements.length ===
            ...
            for (var i = this.bufferAntiEntropy.elements.length-1; i>=0 ; --i){
            ...
            // TODO change it to clean way
            this.emit('updateSequence', this.causality.local.v);
